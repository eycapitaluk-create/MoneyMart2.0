-- =============================================================================
-- MoneyMart: インサイトデモ用シード（Supabase の SQL Editor でそのまま実行）
-- 前提: SUPABASE_SETUP_INSIGHTS.sql を先に実行してテーブルがあること
-- 実行後: アプリで /insights または /insights/demo-oil-2026 を開く
-- =============================================================================

insert into public.insight_articles (slug, page_title, document, is_published, published_at)
values (
  'demo-oil-2026',
  'オイルショックで勝つ投資戦略（デモ）',
  $mm_insight_seed_body_v1$
{
  "hero": {
    ...
    "sub": "1973年、1979年、そして2026年——歴史は3度目の石油危機を迎えた。過去のデータが示す「危機で資産を守り伸ばす」ための視点を整理しました。",
    "meta": [
      "MoneyMart Research",
      "2026.03.26",
      "読了 8分"
  ...
  "sections": [
    {
      ...
      "lead": "地政学リスクとエネルギー供給のボトルネックは、ポートフォリオのボラティリティと相関構造をいったんリセットします。",
      "paragraphs": [
  ...
  "footer": {
    "disclaimer": "※本ページは情報提供を目的としたものであり、特定の金融商品の購入・売却を推奨するものではありません。投資判断はご自身の責任において行ってください。"
  }
}
$mm_insight_seed_body_v1$::jsonb,
  true,
  now()
)
